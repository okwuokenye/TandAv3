...
namespace TandA.Models
{
    public class EmployeeAbsenteeismModel
    {
        ...
        public EmployeeAbsenteeismModel(Int32 p_Id, String p_EmployeeReference, DateTime p_DateAbsent, DateTime p_TimeAbsent, DateTime p_TimeTo, String p_AbsentRef, String p_Note)
        {
            Id = p_Id;
